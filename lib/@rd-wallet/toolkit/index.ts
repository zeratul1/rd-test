...
class RDToolkit {
  ...
  public async openBalance(accountId: string): Promise<OpenBalanceResponse> {
    ...
    console.log('open balance request: \n', request);
    console.log('open balance resp: \n', resp);
  ...
  public async accountDetail(accountId: string): Promise<OpenAccountQueryResponse> {
    ...
    console.log('account detail request: \n', request);
    console.log('account detail resp: \n', resp);
...
export { ICallback, Profile, RDToolkit, Encrypt, Decrypt, OpenBalanceResponse };